...
import MultiBackend, { DndProvider, PreviewContext, usePreview, Preview } from "react-dnd-multi-backend";
...
const App = () => {
    ...
    const newAPI = <DndProvider options={HTML5toTouch}>{getContent("New", refNew)}</DndProvider>;
